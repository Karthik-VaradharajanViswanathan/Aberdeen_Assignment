...
6. To use xpaths
i) install package -> npm install cypress-xpath --save-dev
ii) import plugin to your e2e tests -> require("cypress-xpath");
iii) Add Xpath reference in all tests -> /// <reference types="cypress-xpath" />

7. To execute tests using script commands
//npm run scriptname 